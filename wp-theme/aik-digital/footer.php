...
$youtube_url  = get_field( 'social_youtube_url', 'option' );
$tiktok_url   = get_field( 'social_tiktok_url', 'option' );
...
if ( empty( $facebook_url ) ) {
	$facebook_url = 'https://www.facebook.com/aikbyBankIslami/';
}
if ( empty( $instagram_url ) ) {
	$instagram_url = 'https://www.instagram.com/aik_digital/';
}
if ( empty( $youtube_url ) ) {
	$youtube_url = 'https://www.youtube.com/@aikdigital1';
}
if ( empty( $tiktok_url ) ) {
	$tiktok_url = 'https://www.tiktok.com/@aikbybankislami/';
}
if ( empty( $linkedin_url ) ) {
	$linkedin_url = 'https://www.linkedin.com/company/aikbybankislami/';
}
      ...
      <div class="aik-footer__body footer_content">
        <div class="container">
          <div class="aik-footer__grid">
            ...
            <div class="aik-footer__col custom_column">
...
<!--             <div class="aik-footer__col">
            ...
            <div class="aik-footer__col aik-footer__col--app">
              ...
              <h6 class="aik-footer__heading aik-footer__heading--social">Social Platforms</h6>
...
<!--                 <a href="<?php echo esc_url( $twitter_url ? $twitter_url : '#' ); ?>" class="aik-footer__social-btn" aria-label="Twitter"><i class="bi bi-twitter-x"></i></a> -->
                ...
                <a href="<?php echo esc_url( $youtube_url ); ?>" target="_blank" class="aik-footer__social-btn" aria-label="YouTube"><i class="bi bi-youtube"></i></a>
                <a href="<?php echo esc_url( $tiktok_url ); ?>" target="_blank" class="aik-footer__social-btn" aria-label="TikTok"><i class="bi bi-tiktok"></i></a>
                <a href="<?php echo esc_url( $linkedin_url ); ?>" target="_blank" class="aik-footer__social-btn" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container footer_content">
        <div class="aik-footer__bottom">
          <div class="aik-footer__bottom-inner">
            ...
            <nav class="aik-footer__legal"><a href="https://wordpress-732216-6548062.cloudwaysapps.com/privacy-policy/">Privacy Policy</a> <span class="aik-footer__pipe">|</span> <a href="https://wordpress-732216-6548062.cloudwaysapps.com/terms-condition/">Terms &amp; Conditions</a></nav>
          </div>
        </div>
      </div>
